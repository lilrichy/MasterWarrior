...
//		stage.setViewport(new FitViewport(800, 480, new PerspectiveCamera()));
        ...
        logo = new Image(atlas.findRegion("masterwarrior-logo"));
        ...
        game.manager.load("ui/atlas.pack", TextureAtlas.class);
    ...
    public void hide() {
        ...
        game.manager.unload("loading/loading.pack");
    }
}